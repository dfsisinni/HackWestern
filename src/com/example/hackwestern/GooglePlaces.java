...
import com.example.hackwestern.Place.Location;
...
public class GooglePlaces {
	...
	public PlacesResult searchNearby( double lat, double lng, double d, PlacesQueryOptions options ) {
		try {
			URIBuilder url = new URIBuilder( NEARBY_SEARCH_URL );
			url.addParameter( "key", this.apikey );
			url.addParameter( PlacesQueryOptions.LOCATION, lat + "," + lng );
			url.addParameter( PlacesQueryOptions.RADIUS, String.valueOf( d ) );
